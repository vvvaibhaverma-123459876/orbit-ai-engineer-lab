...
present in the supplied Part I–V syllabus documents. Those 806 terms are
marked `machine-extracted` and still require human review; the remaining new
topics are intentionally left in the authoring queue rather than presented as
finished syllabus coverage.
